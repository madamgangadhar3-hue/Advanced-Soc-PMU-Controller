...
set ::env(CURRENT_NETLIST) "./results/synthesis/pmu_controller.v";
...
set ::env(SAVE_DEF) "./results/floorplan/pmu_controller.def";
set ::env(SAVE_NETLIST) "./out.v";
set ::env(SAVE_ODB) "./results/floorplan/pmu_controller.odb";
