module pmu_controller (app_idle,
 ...
 sky130_fd_sc_hd__o21bai_1 _17_ (.A1(net4),
    ...
    .VPWR(VPWR),
    .Y(_01_));
 sky130_fd_sc_hd__dfrtp_1 _18_ (.CLK(clknet_1_1__leaf_clk),
    .D(_00_),
    .RESET_B(net2),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net6));
 sky130_fd_sc_hd__dfrtp_2 _19_ (.CLK(clknet_1_0__leaf_clk),
    .D(_01_),
    .RESET_B(net2),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_1 input2 (.A(reset_n),
    ...
    .VPWR(VPWR),
    .X(net2));
 sky130_fd_sc_hd__buf_1 input3 (.A(thermal_alert),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_2_62 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_6 FILLER_0_2_74 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
